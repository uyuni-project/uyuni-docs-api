...
* <<apidoc-system_appstreams-ssmDisable-loggedInUser-channelId-moduleNames-earliestOccurrence,ssmDisable>>
* <<apidoc-system_appstreams-ssmEnable-loggedInUser-channelId-moduleStreams-earliestOccurrence,ssmEnable>>
...
[#apidoc-system_appstreams-ssmDisable-loggedInUser-channelId-moduleNames-earliestOccurrence]
== Method: ssmDisable
...
Schedule disabling of module streams from a given modular channel for the SSM (System Set Manager)
...
[#apidoc-system_appstreams-ssmEnable-loggedInUser-channelId-moduleStreams-earliestOccurrence]
== Method: ssmEnable
...
Schedule enabling of module streams from a given modular channel for the SSM (System Set Manager)
 systems. Invalid modules will be filtered out. If all provided modules are invalid the request will fail.
