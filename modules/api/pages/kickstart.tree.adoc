...
Create a Kickstart Tree (Distribution) in {productname}.
...
Delete a Kickstart Tree (Distribution) from {productname}.
...
Rename a Kickstart Tree (Distribution) in {productname}.
...
Edit a Kickstart Tree (Distribution) in {productname}.
