...
* <<apidoc-admin-create-512521244,create>>
* <<apidoc-admin-create-1626803358,create>>
* <<apidoc-admin-delete-300648514,delete>>
* <<apidoc-admin-getDetails-1235287572,getDetails>>
* <<apidoc-admin-list-879837202,list>>
* <<apidoc-admin-setDetails-1840663231,setDetails>>
...
[#apidoc-admin-create-1626803358]
== Method: create 
...
[#apidoc-admin-getDetails-1235287572]
== Method: getDetails 
...
[#apidoc-admin-setDetails-1840663231]
== Method: setDetails 
