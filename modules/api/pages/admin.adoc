...
* <<apidoc-admin-create-741658148,create>>
* <<apidoc-admin-create-1492700687,create>>
* <<apidoc-admin-delete-795815313,delete>>
* <<apidoc-admin-getDetails-838403351,getDetails>>
* <<apidoc-admin-list-1001830827,list>>
* <<apidoc-admin-setDetails-826306219,setDetails>>
...
[#apidoc-admin-create-1492700687]
== Method: create
...
[#apidoc-admin-getDetails-838403351]
== Method: getDetails
...
[#apidoc-admin-setDetails-826306219]
== Method: setDetails
