...
* <<apidoc-admin-create-1328968427,create>>
* <<apidoc-admin-create-578967394,create>>
* <<apidoc-admin-delete-400758359,delete>>
* <<apidoc-admin-getDetails-669678735,getDetails>>
* <<apidoc-admin-list-1538784312,list>>
* <<apidoc-admin-setDetails-887596583,setDetails>>
...
[#apidoc-admin-create-1328968427]
== Method: create
...
[#apidoc-admin-getDetails-669678735]
== Method: getDetails
...
[#apidoc-admin-setDetails-887596583]
== Method: setDetails
