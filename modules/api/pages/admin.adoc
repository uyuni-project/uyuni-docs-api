...
* <<apidoc-admin-create-861715645,create>>
* <<apidoc-admin-create-1690803049,create>>
* <<apidoc-admin-delete-1514502817,delete>>
* <<apidoc-admin-getDetails-42050891,getDetails>>
* <<apidoc-admin-list-1424900671,list>>
* <<apidoc-admin-setDetails-177522915,setDetails>>
...
[#apidoc-admin-create-1690803049]
== Method: create
...
[#apidoc-admin-delete-1514502817]
== Method: delete
...
[#apidoc-admin-getDetails-42050891]
== Method: getDetails
...
[#apidoc-admin-setDetails-177522915]
== Method: setDetails
