...
* <<apidoc-channel_software-isAutoSync-loggedInUser-channelLabel,isAutoSync>>
...
* <<apidoc-channel_software-setAutoSync-loggedInUser-channelLabel-autoSync,setAutoSync>>
...
** [.string]#string#  "sync_status" - 'C' for new created, 'S' for syncing and 'R' for ready
...
[#apidoc-channel_software-isAutoSync-loggedInUser-channelLabel]
== Method: isAutoSync
...
Returns whether is synchronized automatically
...
* [.boolean]#boolean#  result - true if the channel is synchronized automatically
...
** [.string]#string#  "advisory_status" - status label such as 'final', 'testing', 'stable', 'pending',
...
[#apidoc-channel_software-setAutoSync-loggedInUser-channelLabel-autoSync]
== Method: setAutoSync
...
Sets whether the channel is synchronized automatically
...
* [.Boolean]#Boolean#  autoSync - Value to set on the channel automatic synchronization
 

Returns:

* [.boolean]#boolean#  result - The value set to the channel automatic synchronized option
