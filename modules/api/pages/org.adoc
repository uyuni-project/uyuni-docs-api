...
Returns whether Organization Administrator is able to manage his
 organization configuration. This may have a high impact on general {productname} performance.
...
Transfer systems from one organization to another.  If executed by
 a {productname} administrator, the systems will be transferred from their current
...
Sets whether Organization Administrator can manage his organization
 configuration. This may have a high impact on general {productname} performance.
