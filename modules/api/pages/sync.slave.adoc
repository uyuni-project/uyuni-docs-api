...
* <<apidoc-sync_slave-create-1937337061,create>>
* <<apidoc-sync_slave-delete-800329289,delete>>
* <<apidoc-sync_slave-getAllowedOrgs-928416421,getAllowedOrgs>>
* <<apidoc-sync_slave-getSlave-244842574,getSlave>>
* <<apidoc-sync_slave-getSlaveByName-915307834,getSlaveByName>>
* <<apidoc-sync_slave-getSlaves-941557161,getSlaves>>
* <<apidoc-sync_slave-setAllowedOrgs-2038595185,setAllowedOrgs>>
* <<apidoc-sync_slave-update-961997107,update>>
...
[#apidoc-sync_slave-create-1937337061]
== Method: create 
...
[#apidoc-sync_slave-delete-800329289]
== Method: delete 
...
[#apidoc-sync_slave-getAllowedOrgs-928416421]
...
[#apidoc-sync_slave-getSlave-244842574]
== Method: getSlave 
...
[#apidoc-sync_slave-getSlaveByName-915307834]
...
[#apidoc-sync_slave-getSlaves-941557161]
== Method: getSlaves 
...
[#apidoc-sync_slave-setAllowedOrgs-2038595185]
...
[#apidoc-sync_slave-update-961997107]
== Method: update 
