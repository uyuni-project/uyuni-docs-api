...
* <<apidoc-sync_slave-create-941456460,create>>
* <<apidoc-sync_slave-delete-631181275,delete>>
* <<apidoc-sync_slave-getAllowedOrgs-1092507262,getAllowedOrgs>>
* <<apidoc-sync_slave-getSlave-1700614789,getSlave>>
* <<apidoc-sync_slave-getSlaveByName-921812350,getSlaveByName>>
* <<apidoc-sync_slave-getSlaves-472019958,getSlaves>>
* <<apidoc-sync_slave-setAllowedOrgs-1314450850,setAllowedOrgs>>
* <<apidoc-sync_slave-update-506890727,update>>
...
[#apidoc-sync_slave-create-941456460]
== Method: create 
...
[#apidoc-sync_slave-delete-631181275]
== Method: delete 
...
[#apidoc-sync_slave-getAllowedOrgs-1092507262]
...
[#apidoc-sync_slave-getSlave-1700614789]
== Method: getSlave 
...
[#apidoc-sync_slave-getSlaveByName-921812350]
...
[#apidoc-sync_slave-getSlaves-472019958]
== Method: getSlaves 
...
[#apidoc-sync_slave-setAllowedOrgs-1314450850]
...
[#apidoc-sync_slave-update-506890727]
== Method: update 
