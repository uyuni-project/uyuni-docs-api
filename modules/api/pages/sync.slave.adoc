...
* <<apidoc-sync_slave-create-2104281815,create>>
* <<apidoc-sync_slave-delete-1209765203,delete>>
* <<apidoc-sync_slave-getAllowedOrgs-2052728503,getAllowedOrgs>>
* <<apidoc-sync_slave-getSlave-1854154410,getSlave>>
* <<apidoc-sync_slave-getSlaveByName-1965388767,getSlaveByName>>
* <<apidoc-sync_slave-getSlaves-1858035494,getSlaves>>
* <<apidoc-sync_slave-setAllowedOrgs-891612704,setAllowedOrgs>>
* <<apidoc-sync_slave-update-1301992318,update>>
...
[#apidoc-sync_slave-create-2104281815]
== Method: create 
...
[#apidoc-sync_slave-delete-1209765203]
== Method: delete 
...
[#apidoc-sync_slave-getAllowedOrgs-2052728503]
...
[#apidoc-sync_slave-getSlave-1854154410]
== Method: getSlave 
...
[#apidoc-sync_slave-getSlaveByName-1965388767]
...
[#apidoc-sync_slave-getSlaves-1858035494]
== Method: getSlaves 
...
[#apidoc-sync_slave-setAllowedOrgs-891612704]
...
[#apidoc-sync_slave-update-1301992318]
== Method: update 
