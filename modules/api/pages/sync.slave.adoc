...
* <<apidoc-sync_slave-create-565678786,create>>
* <<apidoc-sync_slave-delete-856511870,delete>>
* <<apidoc-sync_slave-getAllowedOrgs-994372924,getAllowedOrgs>>
* <<apidoc-sync_slave-getSlave-179672552,getSlave>>
* <<apidoc-sync_slave-getSlaveByName-386480126,getSlaveByName>>
* <<apidoc-sync_slave-getSlaves-1648091808,getSlaves>>
* <<apidoc-sync_slave-setAllowedOrgs-502805865,setAllowedOrgs>>
* <<apidoc-sync_slave-update-1644361919,update>>
...
[#apidoc-sync_slave-create-565678786]
== Method: create 
...
[#apidoc-sync_slave-delete-856511870]
== Method: delete 
...
[#apidoc-sync_slave-getAllowedOrgs-994372924]
...
[#apidoc-sync_slave-getSlave-179672552]
== Method: getSlave 
...
[#apidoc-sync_slave-getSlaveByName-386480126]
...
[#apidoc-sync_slave-getSlaves-1648091808]
== Method: getSlaves 
...
[#apidoc-sync_slave-setAllowedOrgs-502805865]
...
[#apidoc-sync_slave-update-1644361919]
== Method: update 
