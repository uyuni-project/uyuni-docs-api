...
* <<apidoc-sync_slave-create-1313152922,create>>
* <<apidoc-sync_slave-delete-794413935,delete>>
* <<apidoc-sync_slave-getAllowedOrgs-1518422518,getAllowedOrgs>>
* <<apidoc-sync_slave-getSlave-1623964247,getSlave>>
* <<apidoc-sync_slave-getSlaveByName-102027291,getSlaveByName>>
* <<apidoc-sync_slave-getSlaves-1004728150,getSlaves>>
* <<apidoc-sync_slave-setAllowedOrgs-1730497011,setAllowedOrgs>>
* <<apidoc-sync_slave-update-2015935595,update>>
...
[#apidoc-sync_slave-create-1313152922]
== Method: create 
...
[#apidoc-sync_slave-delete-794413935]
== Method: delete 
...
[#apidoc-sync_slave-getAllowedOrgs-1518422518]
...
[#apidoc-sync_slave-getSlave-1623964247]
== Method: getSlave 
...
[#apidoc-sync_slave-getSlaveByName-102027291]
...
[#apidoc-sync_slave-getSlaves-1004728150]
== Method: getSlaves 
...
[#apidoc-sync_slave-setAllowedOrgs-1730497011]
...
[#apidoc-sync_slave-update-2015935595]
== Method: update 
