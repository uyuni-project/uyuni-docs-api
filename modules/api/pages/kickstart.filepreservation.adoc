...
* <<apidoc-kickstart_filepreservation-create-1413952420,create>>
* <<apidoc-kickstart_filepreservation-delete-1378841761,delete>>
* <<apidoc-kickstart_filepreservation-getDetails-1500512598,getDetails>>
* <<apidoc-kickstart_filepreservation-listAllFilePreservations-1024412356,listAllFilePreservations>>
...
[#apidoc-kickstart_filepreservation-create-1413952420]
== Method: create 
...
[#apidoc-kickstart_filepreservation-delete-1378841761]
== Method: delete 
...
[#apidoc-kickstart_filepreservation-getDetails-1500512598]
== Method: getDetails 
...
[#apidoc-kickstart_filepreservation-listAllFilePreservations-1024412356]
