...
* <<apidoc-proxy-backupConfiguration-loggedInUser-sids,backupConfiguration>>
...
* <<apidoc-proxy-containerConfig-loggedInUser-proxyName-proxyPort-server-maxCache-email,containerConfig>>
...
[#apidoc-proxy-backupConfiguration-loggedInUser-sids]
...
[#apidoc-proxy-containerConfig-loggedInUser-proxyName-proxyPort-server-maxCache-email]
== Method: containerConfig
...
Compute and download the configuration for proxy containers without adding the TLS certificate
