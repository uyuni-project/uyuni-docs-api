...
* <<apidoc-system-setCoCoAttestationConfig-loggedInUser-sid-enabled-environmentType,setCoCoAttestationConfig>>
...
[#apidoc-system-setCoCoAttestationConfig-loggedInUser-sid-enabled-environmentType]
...
* [.boolean]#boolean#  enabled - set the endabled state for Confidential Compute Attestation
