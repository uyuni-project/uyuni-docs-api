...
* <<apidoc-system-listMigrationTargetsWithChannels-loggedInUser-sid,listMigrationTargetsWithChannels>>
...
* <<apidoc-system-provisionSystem-loggedInUser-sid-profileName-earliestDate-advancedOptions,provisionSystem>>
* <<apidoc-system-provisionSystem-loggedInUser-request-sid-profileName-earliestDate-advancedOptions,provisionSystem>>
...
* <<apidoc-system-scheduleSupportDataUpload-loggedInUser-sid-caseNumber-parameter-uploadGeo-earliestOccurrence,scheduleSupportDataUpload>>
...
[#apidoc-system-listMigrationTargetsWithChannels-loggedInUser-sid]
== Method: listMigrationTargetsWithChannels

HTTP `GET`

Description:

Lists the eligible migration targets for a given server, including channel details.
...
* [.array]#array# :
** [.struct]#struct#  migration target
*** [.string]#string#  "ident"
*** [.string]#string#  "friendly"
*** [.array]#array#  "channel_options"
**** [.struct]#struct#  channel option
***** [.string]#string#  "base_channel_label"
***** [.string]#string#  "base_channel_name"
***** [.array]#array#  "child_channels"
...
[#apidoc-system-provisionSystem-loggedInUser-sid-profileName-earliestDate-advancedOptions]
== Method: provisionSystem
...
[#apidoc-system-provisionSystem-loggedInUser-request-sid-profileName-earliestDate-advancedOptions]
== Method: provisionSystem
...
[#apidoc-system-scheduleSupportDataUpload-loggedInUser-sid-caseNumber-parameter-uploadGeo-earliestOccurrence]
== Method: scheduleSupportDataUpload

HTTP `POST`

Description:

Schedule an action to get and upload support data from the specified system to SCC.
...
* [.string]#string#  caseNumber - The SCC case number
 
* [.string]#string#  parameter - Additional parameter for the tool which collect the data from the system. Can be empty
 
* [.string]#string#  uploadGeo - The location of the upload server [EU, US]
