...
* <<apidoc-channel-listSoftwareChannelsByAutoSync-loggedInUser-autoSync,listSoftwareChannelsByAutoSync>>
...
[#apidoc-channel-listSoftwareChannelsByAutoSync-loggedInUser-autoSync]
== Method: listSoftwareChannelsByAutoSync
...
* [.Boolean]#Boolean#  autoSync - If should return channels with auto-sync
                                                   enabled (true) or disabled (false)
 

Returns:

* [.array]#string array#  the list of channel labels
