...
* <<apidoc-subscriptionmatching_pinnedsubscription-create-772065437,create>>
* <<apidoc-subscriptionmatching_pinnedsubscription-delete-779998468,delete>>
* <<apidoc-subscriptionmatching_pinnedsubscription-list-748199298,list>>
...
[#apidoc-subscriptionmatching_pinnedsubscription-create-772065437]
== Method: create 
...
[#apidoc-subscriptionmatching_pinnedsubscription-delete-779998468]
== Method: delete 
...
[#apidoc-subscriptionmatching_pinnedsubscription-list-748199298]
== Method: list 
