...
Add a new channel to the {productname} database
...
Add organization credentials (mirror credentials) to {productname}.
...
Delete organization credentials (mirror credentials) from {productname}.
