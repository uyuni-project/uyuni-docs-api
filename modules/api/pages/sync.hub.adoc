...
* <<apidoc-sync_hub-listPeripheralServers-loggedInUser,listPeripheralServers>>
...
* <<apidoc-sync_hub-scheduleUpdateTask-loggedInUser,scheduleUpdateTask>>
* <<apidoc-sync_hub-scheduleUpdateTask-loggedInUser-earliest,scheduleUpdateTask>>
* <<apidoc-sync_hub-scheduleUpdateTask-loggedInUser-earliest-withReposync,scheduleUpdateTask>>
...
** [.string]#string#  "label" - the label of the channel
...
[#apidoc-sync_hub-listPeripheralServers-loggedInUser]
== Method: listPeripheralServers
...
* [.array]#array# :
** [.struct]#struct#  peripheral_server
*** [.string]#string#  "fqdn" - The FQDN of the peripheral server
*** [.int]#int#  "id" - The system ID of the peripheral server
*** [.string]#string#  "root_ca" - The root CA certificate of the peripheral server
...
[#apidoc-sync_hub-scheduleUpdateTask-loggedInUser]
== Method: scheduleUpdateTask
...
[#apidoc-sync_hub-scheduleUpdateTask-loggedInUser-earliest]
== Method: scheduleUpdateTask
...
* [.dateTime.iso8601]#dateTime.iso8601#  earliest - earliest time the task will be executed.
...
[#apidoc-sync_hub-scheduleUpdateTask-loggedInUser-earliest-withReposync]
== Method: scheduleUpdateTask
...
* [.boolean]#boolean#  withReposync - if true reposync will be run after mgr-sync refresh
