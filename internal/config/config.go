...
// NavConfig holds navigation generation settings.
type NavConfig struct {
	// Prepend lists xref lines to add before the generated entries in nav-api-guide.adoc.
	// Format: "xref:file.adoc[Label]"
