...
// langSelectorEntry produces the HTML anchor for one language.
...
// InjectLangSelector replaces the placeholder comment in the given
// header-content.hbs file with anchor tags for every non-English language
// that has a flag_svg defined in the config.
